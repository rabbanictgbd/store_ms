	...
	<html>
		...
		<body>
			...
			<div class="container"> <!--cointainer start-->
				...
				<div class="cointainer-foulid"> <!--body start-->
					...
					<div class="row">
						...
						<div class="col-sm-9"> <!--right bar start-->
							<div class="row p-2 border-start border-success">
								<div class="col-sm-3">
							...
							<hr/>
								...
								<div class="col-sm-3">
									<a href="list_of_spend_product.php"><i class="fa-solid fa-box fa-5x text-success"> </i> </a>
							...
							<hr/>
								...
								<div class="col-sm-3">
									<a href="list_of_user.php"><i class="fa-solid fa-users fa-5x text-success"> </i> </a>
									<p> User List </p>
								</div>
								<div class="col-sm-3">
				...
				<div class="cointainer-foulid border-top border-success p-0 bottom-0 bg-success"> <!--bottom bar start-->
